...
//chip's harry potter and the deathly hallows part 1 patch added 
...
#include <vector> //chip
#include <Psapi.h> // Include Psapi.h for GetModuleFileNameEx _ chip
...
void PerformHexEdit(LPBYTE lpAddress, DWORD moduleSize) {
    ...
    std::vector<HexEdit> edits = {
        // FOV dementor zooming issue edit
        { { 0xD9, 0xCD, 0xD9, 0x44, 0x24, 0x10, 0x33, 0xC9, 0xDE, 0xCD, 0xB8, 0xCC, 0x34, 0x68, 0x00, 0x51 }, { 0xC2 }, 3 },
        // FOV edit 
        { { 0xDD, 0x05, 0x70, 0x73, 0x69, 0x00, 0xB8, 0xC4, 0x33, 0x68, 0x00, 0xDC, 0xC9, 0x51, 0xD9, 0xC9 }, { 0x10, 0x7A }, 2 },
        // FPS uncap edit
        { { 0xC7, 0x05, 0x94, 0x5D, 0x6F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x8B, 0x0D, 0xC0, 0x24, 0x7B, 0x00, 0x0B, 0x0D, 0xC4, 0x24, 0x7B, 0x00, 0x0F, 0x84 },
          { 0x64, 0xB7, 0x7A, 0x00, 0x83, 0xF9, 0x1A, 0x90, 0x90, 0x90, 0x0F, 0x85 }, 12 }
    };
